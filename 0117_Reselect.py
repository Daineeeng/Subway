...
File_List = glob.glob('C:/Users/DAIN/환경설비팀요청자료2/for_터널미세먼지/5.data_Selected/*.csv')
for file in File_List:
    ...
    df_new.to_csv('C:/Users/DAIN/환경설비팀요청자료2/for_터널미세먼지/6.data_Reselected/data_Combined%s.csv' % name)