...
#
# print(Fdust.query('Month == "9" & 49 <= Fdust_122 <= 49.2'))
...
# print('122min\n', Fdust.loc[Fdust.groupby(['Month'])['Fdust_122'].idxmin()])
#
# print(Fdust.query('Month == "9" & 39 <= Fdust_122 <= 40'))
...
plt.plot(JanFeb_Max.Point, JanFeb_Max.Fdust_122, label='Max 01-31', marker='.', ms=8, ls='-', c='r', lw=2)
...
plt.plot(Jun_Min.Point, Jun_Min.Fdust_122, label='Min 07-01', marker='.', ms=8, ls='-', c='b', lw=2)
plt.plot(Jun_Mean.Point, Jun_Mean.Fdust_122, label='Mean 07-09', marker='.', ms=8, ls='-', c='g', lw=2)
xticks = ['[1]0:00', '[2]3:00', '[3]5:40', '[4]6:30', '[5]7:30', '[6]8:30\npeak',
          '[7]9:30', '[8]10:30', '[9]11:30', '[10]13:25', '[11]15:00', '[12]19:30', '[13]21:00', '[14]22:30']
...
###################################################### 1+2
        ...
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Tae1_122'].values, label='본선배기1', linestyle='--', c='r', lw=2)
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='r', lw=2)
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='darksalmon', lw=2)
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='darksalmon', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (1,2월)\n', fontsize=20)
        ...
        plt.plot(JanFeb_Min['Time'], JanFeb_Min['Tae1_122'].values, label='본선배기1', linestyle='--', c='b', lw=2)
        plt.plot(JanFeb_Min['Time'], JanFeb_Min['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='b', lw=2)
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='lightsteelblue', lw=2)
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='lightsteelblue', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(2, figsize=(20, 24)).add_subplot(413)
        Jan_Mean['Time'] = pd.to_datetime(Jan_Mean['Time'], format='%H:%M:%S')
        plt.plot(Jan_Mean['Time'], Jan_Mean['Tae1_122'].values, label='본선배기1', linestyle='--', c='g', lw=2)
        plt.plot(Jan_Mean['Time'], Jan_Mean['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='g', lw=2)
        plt.plot(Jan_Mean['Time'], Jan_Mean['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='y', lw=2)
        plt.plot(Jan_Mean['Time'], Jan_Mean['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='y', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(2, figsize=(20, 24)).add_subplot(414)
        Feb_Mean['Time'] = pd.to_datetime(Feb_Mean['Time'], format='%H:%M:%S')
        plt.plot(Feb_Mean['Time'], Feb_Mean['Tae1_122'].values, label='본선배기1', linestyle='--', c='m', lw=2)
        plt.plot(Feb_Mean['Time'], Feb_Mean['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='m', lw=2)
        plt.plot(Feb_Mean['Time'], Feb_Mean['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='mediumpurple', lw=2)
        plt.plot(Feb_Mean['Time'], Feb_Mean['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='mediumpurple', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
    ...
    ###################################################### 3
        ...
        plt.plot(Mar_Max['Time'], Mar_Max['Tae1_122'].values, label='본선배기1', linestyle='--', c='r', lw=2)
        plt.plot(Mar_Max['Time'], Mar_Max['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='r', lw=2)
        plt.plot(Mar_Max['Time'], Mar_Max['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='darksalmon', lw=2)
        plt.plot(Mar_Max['Time'], Mar_Max['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='darksalmon', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (3월)\n', fontsize=20)
        ...
        plt.plot(Mar_Min['Time'], Mar_Min['Tae1_122'].values, label='본선배기1', linestyle='--', c='b', lw=2)
        plt.plot(Mar_Min['Time'], Mar_Min['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='b', lw=2)
        plt.plot(Mar_Min['Time'], Mar_Min['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='lightsteelblue', lw=2)
        plt.plot(Mar_Min['Time'], Mar_Min['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='lightsteelblue', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(4, figsize=(20, 24)).add_subplot(313)
        Mar_Mean['Time'] = pd.to_datetime(Mar_Mean['Time'], format='%H:%M:%S')
        plt.plot(Mar_Mean['Time'], Mar_Mean['Tae1_122'].values, label='본선배기1', linestyle='--', c='g', lw=2)
        plt.plot(Mar_Mean['Time'], Mar_Mean['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='g', lw=2)
        plt.plot(Mar_Mean['Time'], Mar_Mean['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='y', lw=2)
        plt.plot(Mar_Mean['Time'], Mar_Mean['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='y', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
    ...
    ###################################################### 4
        ...
        plt.plot(Apr_Max['Time'], Apr_Max['Tae1_122'].values, label='본선배기1', linestyle='--', c='r', lw=2)
        plt.plot(Apr_Max['Time'], Apr_Max['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='r', lw=2)
        plt.plot(Apr_Max['Time'], Apr_Max['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='darksalmon', lw=2)
        plt.plot(Apr_Max['Time'], Apr_Max['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='darksalmon', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (4월)\n', fontsize=20)
        ...
        plt.plot(Apr_Min['Time'], Apr_Min['Tae1_122'].values, label='본선배기1', linestyle='--', c='b', lw=2)
        plt.plot(Apr_Min['Time'], Apr_Min['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='b', lw=2)
        plt.plot(Apr_Min['Time'], Apr_Min['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='lightsteelblue', lw=2)
        plt.plot(Apr_Min['Time'], Apr_Min['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='lightsteelblue', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(6, figsize=(20, 24)).add_subplot(313)
        Apr_Mean['Time'] = pd.to_datetime(Apr_Mean['Time'], format='%H:%M:%S')
        plt.plot(Apr_Mean['Time'], Apr_Mean['Tae1_122'].values, label='본선배기1', linestyle='--', c='g', lw=2)
        plt.plot(Apr_Mean['Time'], Apr_Mean['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='g', lw=2)
        plt.plot(Apr_Mean['Time'], Apr_Mean['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='y', lw=2)
        plt.plot(Apr_Mean['Time'], Apr_Mean['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='y', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

    ###################################################### 5
        ax = plt.figure(8, figsize=(20, 24)).add_subplot(611)
        May_Max['Time'] = pd.to_datetime(May_Max['Time'], format='%H:%M:%S')
        plt.plot(May_Max['Time'], May_Max['Tae1_122'].values, label='본선배기1', linestyle='--', c='r', lw=2)
        plt.plot(May_Max['Time'], May_Max['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (5월)\n', fontsize=20)

        ax = plt.figure(8, figsize=(20,24)).add_subplot(612)
        plt.plot(May_Max['Time'], May_Max['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='darksalmon', lw=2)
        plt.plot(May_Max['Time'], May_Max['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='darksalmon', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(613)
        May_Min['Time'] = pd.to_datetime(May_Min['Time'], format='%H:%M:%S')
        plt.plot(May_Min['Time'], May_Min['Tae1_122'].values, label='본선배기1', linestyle='--', c='b', lw=2)
        plt.plot(May_Min['Time'], May_Min['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20,24)).add_subplot(614)
        plt.plot(May_Min['Time'], May_Min['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='lightsteelblue', lw=2)
        plt.plot(May_Min['Time'], May_Min['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='lightsteelblue', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(615)
        May_Mean['Time'] = pd.to_datetime(May_Mean['Time'], format='%H:%M:%S')
        plt.plot(May_Mean['Time'], May_Mean['Tae1_122'].values, label='본선배기1', linestyle='--', c='g', lw=2)
        plt.plot(May_Mean['Time'], May_Mean['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20,24)).add_subplot(616)
        plt.plot(May_Mean['Time'], May_Mean['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='y', lw=2)
        plt.plot(May_Mean['Time'], May_Mean['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='y', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
    ...
    # ###################################################### 6
        ...
        plt.plot(Jun_Max['Time'], Jun_Max['Tae1_122'].values, label='본선배기1', linestyle='--', c='r', lw=2)
        plt.plot(Jun_Max['Time'], Jun_Max['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (6월)\n', fontsize=20)

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(612)
        plt.plot(Jun_Max['Time'], Jun_Max['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='darksalmon', lw=2)
        plt.plot(Jun_Max['Time'], Jun_Max['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='darksalmon', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(613)
        Jun_Min['Time'] = pd.to_datetime(Jun_Min['Time'], format='%H:%M:%S')
        plt.plot(Jun_Min['Time'], Jun_Min['Tae1_122'].values, label='본선배기1', linestyle='--', c='b', lw=2)
        plt.plot(Jun_Min['Time'], Jun_Min['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(614)
        plt.plot(Jun_Min['Time'], Jun_Min['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='lightsteelblue', lw=2)
        plt.plot(Jun_Min['Time'], Jun_Min['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='lightsteelblue', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(615)
        Jun_Mean['Time'] = pd.to_datetime(Jun_Mean['Time'], format='%H:%M:%S')
        plt.plot(Jun_Mean['Time'], Jun_Mean['Tae1_122'].values, label='본선배기1', linestyle='--', c='g', lw=2)
        plt.plot(Jun_Mean['Time'], Jun_Mean['Tae2_122'].values + 0.1, label='본선배기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(616)
        plt.plot(Jun_Mean['Time'], Jun_Mean['Tae3_122'].values + 0.2, label='본선배기3', linestyle='--', c='y', lw=2)
        plt.plot(Jun_Mean['Time'], Jun_Mean['Tae4_122'].values + 0.3, label='본선배기4', linestyle=':', c='y', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
