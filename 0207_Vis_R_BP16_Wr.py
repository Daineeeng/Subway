...
# # 부평삼거리
# Report = Report[['Month', 'Date', 'Time', 'Report_122']]
# print('122max\n', Report.loc[Report.groupby(['Month'])['Report_122'].idxmax()])
# print('122min\n', Report.loc[Report.groupby(['Month'])['Report_122'].idxmin()])
#
# print(Report.query('Month == "9" & 49 <= Report_122 <= 49.2'))
# print(Report.loc[Report['Report_122'] == 295.843704])
#
# # 간석오거리
...
plt.title('대합실 미세먼지 - 부평삼거리 (1,2월)\n', fontsize=20)

###################################################### 3
# Max
Mar_x = Report[Report['Date'].str.contains('3-16-2017')]
Mar_x = Mar_x.sort_values(by='Point', ascending=True)
Mar_Max = Mar_x.groupby(Mar_x.Point).mean()
Mar_Max = Mar_Max['Report_122']
Mar_Max = Mar_Max.to_frame()
Mar_Max.reset_index(level='Point', inplace=True)
# Min
Mar_i = Report[Report['Date'].str.contains('3-31-2017')]
Mar_i = Mar_i.sort_values(by='Point', ascending=True)
Mar_Min = Mar_i.groupby(Mar_i.Point).mean()
Mar_Min = Mar_Min['Report_122']
Mar_Min = Mar_Min.to_frame()
Mar_Min.reset_index(level='Point', inplace=True)
# Mean
Mar_n = Report[Report['Date'].str.contains('3-1-2017')]
Mar_n = Mar_n.sort_values(by='Point', ascending=True)
Mar_Mean = Mar_n.groupby(Mar_n.Point).mean()
Mar_Mean = Mar_Mean['Report_122']
Mar_Mean = Mar_Mean.to_frame()
Mar_Mean.reset_index(level='Point', inplace=True)

plt.figure(3, figsize=(20, 24))
plt.plot(Mar_Max.Point, Mar_Max.Report_122, label='Max 03-16', marker='.', ms=8, ls='-', c='r', lw=2)
plt.plot(Mar_Min.Point, Mar_Min.Report_122, label='Min 03-31', marker='.', ms=8, ls='-', c='b', lw=2)
plt.plot(Mar_Mean.Point, Mar_Mean.Report_122, label='Mean 03-01', marker='.', ms=8, ls='-', c='g', lw=2)
xticks = ['[1]0:00', '[2]3:00', '[3]5:40', '[4]6:30', '[5]7:30', '[6]8:30\npeak',
          '[7]9:30', '[8]10:30', '[9]11:30', '[10]13:25', '[11]15:00', '[12]19:30', '[13]21:00', '[14]22:30']
...
plt.ylabel('대합실 미세먼지\n')
plt.legend(fontsize=12)
plt.title('대합실 미세먼지 - 부평삼거리 (3월)\n', fontsize=20)

###################################################### 4
# Max
Apr_x = Report[Report['Date'].str.contains('4-26-2017')]
Apr_x = Apr_x.sort_values(by='Point', ascending=True)
Apr_Max = Apr_x.groupby(Apr_x.Point).mean()
Apr_Max = Apr_Max['Report_122']
Apr_Max = Apr_Max.to_frame()
Apr_Max.reset_index(level='Point', inplace=True)
# Min
Apr_i = Report[Report['Date'].str.contains('4-27-2017')]
Apr_i = Apr_i.sort_values(by='Point', ascending=True)
Apr_Min = Apr_i.groupby(Apr_i.Point).mean()
Apr_Min = Apr_Min['Report_122']
Apr_Min = Apr_Min.to_frame()
Apr_Min.reset_index(level='Point', inplace=True)
# Mean
Apr_n = Report[Report['Date'].str.contains('4-28-2017')]
Apr_n = Apr_n.sort_values(by='Point', ascending=True)
Apr_Mean = Apr_n.groupby(Apr_n.Point).mean()
Apr_Mean = Apr_Mean['Report_122']
Apr_Mean = Apr_Mean.to_frame()
Apr_Mean.reset_index(level='Point', inplace=True)

plt.figure(5, figsize=(20, 24))
plt.plot(Apr_Max.Point, Apr_Max.Report_122, label='Max 04-26', marker='.', ms=8, ls='-', c='r', lw=2)
plt.plot(Apr_Min.Point, Apr_Min.Report_122, label='Min 04-27', marker='.', ms=8, ls='-', c='b', lw=2)
plt.plot(Apr_Mean.Point, Apr_Mean.Report_122, label='Mean 04-28', marker='.', ms=8, ls='-', c='g', lw=2)
xticks = ['[1]0:00', '[2]3:00', '[3]5:40', '[4]6:30', '[5]7:30', '[6]8:30\npeak',
          '[7]9:30', '[8]10:30', '[9]11:30', '[10]13:25', '[11]15:00', '[12]19:30', '[13]21:00', '[14]22:30']
...
plt.ylabel('대합실 미세먼지\n')
plt.legend(fontsize=12)
plt.title('대합실 미세먼지 - 부평삼거리 (4월)\n', fontsize=20)

###################################################### 5
# Max
May_x = Report[Report['Date'].str.contains('5-6-2017')]
May_x = May_x.sort_values(by='Point', ascending=True)
May_Max = May_x.groupby(May_x.Point).mean()
May_Max = May_Max['Report_122']
May_Max = May_Max.to_frame()
May_Max.reset_index(level='Point', inplace=True)
# Min
May_i = Report[Report['Date'].str.contains('5-20-2017')]
May_i = May_i.sort_values(by='Point', ascending=True)
May_Min = May_i.groupby(May_i.Point).mean()
May_Min = May_Min['Report_122']
May_Min = May_Min.to_frame()
May_Min.reset_index(level='Point', inplace=True)
# Mean
May_n = Report[Report['Date'].str.contains('5-9-2017')]
May_n = May_n.sort_values(by='Point', ascending=True)
May_Mean = May_n.groupby(May_n.Point).mean()
May_Mean = May_Mean['Report_122']
May_Mean = May_Mean.to_frame()
May_Mean.reset_index(level='Point', inplace=True)

plt.figure(7, figsize=(20, 24))
plt.plot(May_Max.Point, May_Max.Report_122, label='Max 05-06', marker='.', ms=8, ls='-', c='r', lw=2)
plt.plot(May_Min.Point, May_Min.Report_122, label='Min 05-20', marker='.', ms=8, ls='-', c='b', lw=2)
plt.plot(May_Mean.Point, May_Mean.Report_122, label='Mean 05-09', marker='.', ms=8, ls='-', c='g', lw=2)
xticks = ['[1]0:00', '[2]3:00', '[3]5:40', '[4]6:30', '[5]7:30', '[6]8:30\npeak',
          '[7]9:30', '[8]10:30', '[9]11:30', '[10]13:25', '[11]15:00', '[12]19:30', '[13]21:00', '[14]22:30']
...
plt.ylabel('대합실 미세먼지\n')
plt.legend(fontsize=12)
plt.title('대합실 미세먼지 - 부평삼거리 (5월)\n', fontsize=20)

###################################################### 7
# Max
Jul_x = Report[Report['Date'].str.contains('7-27-2017')]
Jul_x = Jul_x.sort_values(by='Point', ascending=True)
Jul_Max = Jul_x.groupby(Jul_x.Point).mean()
Jul_Max = Jul_Max['Report_122']
Jul_Max = Jul_Max.to_frame()
Jul_Max.reset_index(level='Point', inplace=True)
# Min
Jul_i = Report[Report['Date'].str.contains('7-10-2017')]
Jul_i = Jul_i.sort_values(by='Point', ascending=True)
Jul_Min = Jul_i.groupby(Jul_i.Point).mean()
Jul_Min = Jul_Min['Report_122']
Jul_Min = Jul_Min.to_frame()
Jul_Min.reset_index(level='Point', inplace=True)
# Mean
Jul_n = Report[Report['Date'].str.contains('7-19-2017')]
Jul_n = Jul_n.sort_values(by='Point', ascending=True)
Jul_Mean = Jul_n.groupby(Jul_n.Point).mean()
Jul_Mean = Jul_Mean['Report_122']
Jul_Mean = Jul_Mean.to_frame()
Jul_Mean.reset_index(level='Point', inplace=True)

plt.figure(9, figsize=(20, 24))
plt.plot(Jul_Max.Point, Jul_Max.Report_122, label='Max 07-27', marker='.', ms=8, ls='-', c='r', lw=2)
plt.plot(Jul_Min.Point, Jul_Min.Report_122, label='Min 07-10', marker='.', ms=8, ls='-', c='b', lw=2)
plt.plot(Jul_Mean.Point, Jul_Mean.Report_122, label='Mean 07-19', marker='.', ms=8, ls='-', c='g', lw=2)
xticks = ['[1]0:00', '[2]3:00', '[3]5:40', '[4]6:30', '[5]7:30', '[6]8:30\npeak',
          '[7]9:30', '[8]10:30', '[9]11:30', '[10]13:25', '[11]15:00', '[12]19:30', '[13]21:00', '[14]22:30']
...
###################################################### 1+2
        ...
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='r', lw=2)
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('대합실 미세먼지 - 부평삼거리 (1,2월)\n', fontsize=20)
        ...
        plt.plot(JanFeb_Min['Time'], JanFeb_Min['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='b', lw=2)
        plt.plot(JanFeb_Min['Time'], JanFeb_Min['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(2, figsize=(20, 24)).add_subplot(413)
        Jan_Mean['Time'] = pd.to_datetime(Jan_Mean['Time'], format='%H:%M:%S')
        plt.plot(Jan_Mean['Time'], Jan_Mean['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='g', lw=2)
        plt.plot(Jan_Mean['Time'], Jan_Mean['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(2, figsize=(20, 24)).add_subplot(414)
        Feb_Mean['Time'] = pd.to_datetime(Feb_Mean['Time'], format='%H:%M:%S')
        plt.plot(Feb_Mean['Time'], Feb_Mean['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='m', lw=2)
        plt.plot(Feb_Mean['Time'], Feb_Mean['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='m', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
###################################################### 3
        ...
        plt.plot(Mar_Max['Time'], Mar_Max['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='r', lw=2)
        plt.plot(Mar_Max['Time'], Mar_Max['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('대합실 미세먼지 - 부평삼거리 (3월)\n', fontsize=20)
        ...
        plt.plot(Mar_Min['Time'], Mar_Min['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='b', lw=2)
        plt.plot(Mar_Min['Time'], Mar_Min['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(4, figsize=(20, 24)).add_subplot(313)
        Mar_Mean['Time'] = pd.to_datetime(Mar_Mean['Time'], format='%H:%M:%S')
        plt.plot(Mar_Mean['Time'], Mar_Mean['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='g', lw=2)
        plt.plot(Mar_Mean['Time'], Mar_Mean['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
###################################################### 4
        ...
        plt.plot(Apr_Max['Time'], Apr_Max['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='r', lw=2)
        plt.plot(Apr_Max['Time'], Apr_Max['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('대합실 미세먼지 - 부평삼거리 (4월)\n', fontsize=20)
        ...
        plt.plot(Apr_Min['Time'], Apr_Min['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='b', lw=2)
        plt.plot(Apr_Min['Time'], Apr_Min['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(6, figsize=(20, 24)).add_subplot(313)
        Apr_Mean['Time'] = pd.to_datetime(Apr_Mean['Time'], format='%H:%M:%S')
        plt.plot(Apr_Mean['Time'], Apr_Mean['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='g', lw=2)
        plt.plot(Apr_Mean['Time'], Apr_Mean['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
###################################################### 5
        ...
        plt.plot(May_Max['Time'], May_Max['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='r', lw=2)
        plt.plot(May_Max['Time'], May_Max['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('대합실 미세먼지 - 부평삼거리 (5월)\n', fontsize=20)
        ...
        plt.plot(May_Min['Time'], May_Min['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='b', lw=2)
        plt.plot(May_Min['Time'], May_Min['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(313)
        May_Mean['Time'] = pd.to_datetime(May_Mean['Time'], format='%H:%M:%S')
        plt.plot(May_Mean['Time'], May_Mean['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='g', lw=2)
        plt.plot(May_Mean['Time'], May_Mean['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
###################################################### 7
        ...
        plt.plot(Jul_Max['Time'], Jul_Max['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='r', lw=2)
        plt.plot(Jul_Max['Time'], Jul_Max['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('대합실 미세먼지 - 부평삼거리 (7월)\n', fontsize=20)
        ...
        plt.plot(Jul_Min['Time'], Jul_Min['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='b', lw=2)
        plt.plot(Jul_Min['Time'], Jul_Min['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(10, figsize=(20, 24)).add_subplot(313)
        Jul_Mean['Time'] = pd.to_datetime(Jul_Mean['Time'], format='%H:%M:%S')
        plt.plot(Jul_Mean['Time'], Jul_Mean['Wr1_122'].values, label='대합실공조기1', linestyle='--', c='g', lw=2)
        plt.plot(Jul_Mean['Time'], Jul_Mean['Wr2_122'].values + 0.1, label='대합실공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
