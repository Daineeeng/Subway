...
###################################################### 1+2
        ...
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Wr1_122'].values, label='터널공조기1', linestyle='--', c='r', lw=2)
        plt.plot(JanFeb_Max['Time'], JanFeb_Max['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (1,2월)\n', fontsize=20)
        ...
        plt.plot(JanFeb_Min['Time'], JanFeb_Min['Wr1_122'].values, label='터널공조기1', linestyle='--', c='b', lw=2)
        plt.plot(JanFeb_Min['Time'], JanFeb_Min['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(2, figsize=(20, 24)).add_subplot(413)
        Jan_Mean['Time'] = pd.to_datetime(Jan_Mean['Time'], format='%H:%M:%S')
        plt.plot(Jan_Mean['Time'], Jan_Mean['Wr1_122'].values, label='터널공조기1', linestyle='--', c='g', lw=2)
        plt.plot(Jan_Mean['Time'], Jan_Mean['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(2, figsize=(20, 24)).add_subplot(414)
        Feb_Mean['Time'] = pd.to_datetime(Feb_Mean['Time'], format='%H:%M:%S')
        plt.plot(Feb_Mean['Time'], Feb_Mean['Wr1_122'].values, label='터널공조기1', linestyle='--', c='m', lw=2)
        plt.plot(Feb_Mean['Time'], Feb_Mean['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='m', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
###################################################### 3
        ...
        plt.plot(Mar_Max['Time'], Mar_Max['Wr1_122'].values, label='터널공조기1', linestyle='--', c='r', lw=2)
        plt.plot(Mar_Max['Time'], Mar_Max['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (3월)\n', fontsize=20)
        ...
        plt.plot(Mar_Min['Time'], Mar_Min['Wr1_122'].values, label='터널공조기1', linestyle='--', c='b', lw=2)
        plt.plot(Mar_Min['Time'], Mar_Min['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(4, figsize=(20, 24)).add_subplot(313)
        Mar_Mean['Time'] = pd.to_datetime(Mar_Mean['Time'], format='%H:%M:%S')
        plt.plot(Mar_Mean['Time'], Mar_Mean['Wr1_122'].values, label='터널공조기1', linestyle='--', c='g', lw=2)
        plt.plot(Mar_Mean['Time'], Mar_Mean['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
###################################################### 4
        ...
        plt.plot(Apr_Max['Time'], Apr_Max['Wr1_122'].values, label='터널공조기1', linestyle='--', c='r', lw=2)
        plt.plot(Apr_Max['Time'], Apr_Max['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (4월)\n', fontsize=20)
        ...
        plt.plot(Apr_Min['Time'], Apr_Min['Wr1_122'].values, label='터널공조기1', linestyle='--', c='b', lw=2)
        plt.plot(Apr_Min['Time'], Apr_Min['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(6, figsize=(20, 24)).add_subplot(313)
        Apr_Mean['Time'] = pd.to_datetime(Apr_Mean['Time'], format='%H:%M:%S')
        plt.plot(Apr_Mean['Time'], Apr_Mean['Wr1_122'].values, label='터널공조기1', linestyle='--', c='g', lw=2)
        plt.plot(Apr_Mean['Time'], Apr_Mean['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
###################################################### 5
        ...
        plt.plot(May_Max['Time'], May_Max['Wr1_122'].values, label='터널공조기1', linestyle='--', c='r', lw=2)
        plt.plot(May_Max['Time'], May_Max['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='r', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
        plt.title('터널 미세먼지 - 부평삼거리 (5월)\n', fontsize=20)
        ...
        plt.plot(May_Min['Time'], May_Min['Wr1_122'].values, label='터널공조기1', linestyle='--', c='b', lw=2)
        plt.plot(May_Min['Time'], May_Min['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='b', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')

        ax = plt.figure(8, figsize=(20, 24)).add_subplot(313)
        May_Mean['Time'] = pd.to_datetime(May_Mean['Time'], format='%H:%M:%S')
        plt.plot(May_Mean['Time'], May_Mean['Wr1_122'].values, label='터널공조기1', linestyle='--', c='g', lw=2)
        plt.plot(May_Mean['Time'], May_Mean['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='g', lw=2)
        plt.legend(fontsize=12)
        plt.grid(True, ls='--', c='lightgray')
...
#         plt.plot(Jun_Max['Time'], Jun_Max['Wr1_122'].values, label='터널공조기1', linestyle='--', c='r', lw=2)
#         plt.plot(Jun_Max['Time'], Jun_Max['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='r', lw=2)
#         plt.legend(fontsize=12)
#         plt.grid(True, ls='--', c='lightgray')
#         plt.title('터널 미세먼지 - 부평삼거리 (6월)\n', fontsize=20)
#
...
#         plt.plot(Jun_Min['Time'], Jun_Min['Wr1_122'].values, label='터널공조기1', linestyle='--', c='b', lw=2)
#         plt.plot(Jun_Min['Time'], Jun_Min['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='b', lw=2)
#         plt.legend(fontsize=12)
#         plt.grid(True, ls='--', c='lightgray')
#
#         ax = plt.figure(10, figsize=(20, 24)).add_subplot(313)
#         Jun_Mean['Time'] = pd.to_datetime(Jun_Mean['Time'], format='%H:%M:%S')
#         plt.plot(Jun_Mean['Time'], Jun_Mean['Wr1_122'].values, label='터널공조기1', linestyle='--', c='g', lw=2)
#         plt.plot(Jun_Mean['Time'], Jun_Mean['Wr2_122'].values + 0.1, label='터널공조기2', linestyle=':', c='g', lw=2)
#         plt.legend(fontsize=12)
#         plt.grid(True, ls='--', c='lightgray')
